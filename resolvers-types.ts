...
export type IncrementTrackViewsResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['IncrementTrackViewsResponse'] = ResolversParentTypes['IncrementTrackViewsResponse']> = ResolversObject<{
